...
const RankingsIndividual = () => {

    const [expandedPlayer, setExpandedPlayer] = useState(null);

    const individual = ["Bilapredicts Europeu 2024","Teamfight Tactics","Scribbl.io","Brawlhalla","AmongUs"]
    ...
    for (var player in rankingsjson){
        ...
        for (var torneio in torneios){
            if (individual.includes(torneio)){
        ...
        <div>
            ...
            <div className="w3-container w3-light-gray" style={{textAlign:"center"}}>
                <div className="w3-container w3-center" style={{width:"60%",display:"inline-block"}}>
                    <h1 className="w3-center">Ranking Individual</h1>
...
export default RankingsIndividual;
